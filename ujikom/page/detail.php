    ...
    <div class="row">
        <div class="col-6">
            <div class="card">
                ...
                <div class="card-body">
                    <h3 class="card-title mb-0"><?= $data['judul_foto'] ?> <a href="<?php if(isset($_SESSION['user_id'])){echo '?url=like&&id='.$data['foto_id'].'';}else{echo 'login.php';} ?>" class="btn-dark btn btn-sm"><?php if($cek==0){echo 'Like'; }else{echo 'Unlike';} ?> <?= $likes ?></a></h3>
                    ...
                    <form action="?url=detail" method="post">
                        <div class="form-group d-flex flex-row">
                            ...
                            <input type="text" name="isi_komentar" class="form-control" placeholder="Ketikan komentar..." required>
