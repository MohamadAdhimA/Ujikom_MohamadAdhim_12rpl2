        ...
        <div class="col-5">
            ...
            <?php 
                ...
                if($submit=='Upload'){
                    ...
                    if($submit=="Edit"){
                     ...
                     // Attempt to delete associated records from 'komentar_foto' table
                     $delete_comments = mysqli_query($conn, "DELETE FROM komentar_foto WHERE foto_id='$fotoid'");
                     if ($delete_comments) {
                         // Attempt to delete associated records from 'like_foto' table
                         $delete_likes = mysqli_query($conn, "DELETE FROM like_foto WHERE foto_id='$fotoid'");
                         if ($delete_likes) {
                             // Then delete the row from 'foto' table
                             ...
                             echo 'Gagal menghapus like foto yang terkait!';
                             echo '<meta http-equiv="refresh" content="0.8; url=?url=upload">';
                         }
                     } else {
                         echo 'Gagal menghapus komentar foto yang terkait!';
                         echo '<meta http-equiv="refresh" content="0.8; url=?url=upload">';
                     }
                }
            ...
            <form action="?url=upload" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <small class="text-white">File harus berupa *.jpg *.png *.gif</small>
                </div>
